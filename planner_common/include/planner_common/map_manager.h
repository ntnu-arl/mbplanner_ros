...
class MapManager {
 public:
  ...
  virtual VoxelStatus getBoxStatus(const Eigen::Vector3d& center, const Eigen::Vector3d& size,
                                   bool stop_at_unknown_voxel) const = 0;
  virtual VoxelStatus getPathStatus(const Eigen::Vector3d& start, const Eigen::Vector3d& end,
  ...
  virtual void getScanStatus(
      ...
      std::vector<std::pair<Eigen::Vector3d, VoxelStatus>>& voxel_log) = 0;
  ...
  virtual void extractLocalMapAlongAxis(const Eigen::Vector3d& center,
