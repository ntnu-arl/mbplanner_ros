...
class PlannerControlInterface {
 ...
 private:
  ...
  bool stdSrvHomingCallback(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res);
  ...
  bool stdSrvReplanLastSpecifiedFrontierCallback(std_srvs::Trigger::Request &req,
                                                 std_srvs::Trigger::Response &res);
